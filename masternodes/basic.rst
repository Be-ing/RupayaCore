...
#. Open the Debug console to verify that the output from the `masternode list-conf` command matches what you entered in the `masternode.conf` file.
...
#. Run the following command, in the Cold Wallet debug console, in order to enable the MasterNode:
